...
from launcher.views.job import job_detail_view
...
urlpatterns = [
    ...
    path('aggregate/results/<str:result_key>', aggregate_result_file, name='aggregate-result-file'),
    path('aggregate/results-button/<str:result_key>', aggregate_result_view, name='aggregate-result-button'),
]
